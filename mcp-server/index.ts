...
async function fetchFromPlantDB(endpoint: string, options: RequestInit = {}): Promise<any> {
...
async function searchPlants(params: z.infer<typeof SearchPlantsSchema>) {
...
async function predictCare(params: z.infer<typeof PredictCareSchema>) {
...
async function diagnoseSymptoms(params: z.infer<typeof DiagnoseSymptomsSchema>) {
...
async function getPlantDetails(params: z.infer<typeof GetPlantDetailsSchema>) {
  if (params.plantId) {
