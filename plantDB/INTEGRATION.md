...
│  │ • 474 care logs with EC/pH tracking             │   │
│  │ • 506 photos with EXIF metadata                 │   │
│  │ • 46 trait observations                         │   │
...
### Phase 2: Vector Database Integration (Next)
**Status:** 🔄 Planned
...
- Plant trait embeddings (384d)
- Photo CLIP embeddings (768d)
...
```bash
# Database
DATABASE_URL="file:./prisma/dev.db"  # SQLite (current)
DATABASE_URL="postgresql://..."       # PostgreSQL (future)
...
**Current Status:** Phase 1 MCP integration complete and ready for testing.
**Next Step:** Configure Sovria with MCP server and begin using natural language plant queries.