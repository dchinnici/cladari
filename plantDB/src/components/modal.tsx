...
export function Modal({ isOpen, onClose, title, children }: ModalProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 flex items-start sm:items-center justify-center px-4 pt-4 sm:pt-8 pointer-events-none"
        style={{
      ...
      >
        ...
        >
          ...
          <div
            className="flex-1 p-5 pt-4 overflow-y-auto"
            style={{
