    ...
    <div className="min-h-screen bg-[var(--bg-primary)]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-2xl font-semibold text-[var(--forest)]">Breed</h1>
            <p className="text-sm text-[var(--clay)]">
              Sexual & asexual propagation tracking
            </p>
          </div>
          <button
        ...
        {/* Tab Navigation */}
        <div className="flex gap-1 mb-6 border-b border-black/[0.08]">
          <Link
            href="/breeding"
            className="px-4 py-2 text-sm font-medium text-[var(--clay)] hover:text-[var(--bark)] transition-colors"
          >
            Crosses
          </Link>
          <div className="px-4 py-2 text-sm font-medium text-[var(--forest)] border-b-2 border-[var(--forest)]">
            Batches
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white border border-black/[0.06] rounded-xl p-4">
            <div className="flex items-center gap-2 mb-2">
              <Package className="w-4 h-4 text-[var(--clay)]" />
              <span className="text-xs text-[var(--clay)] uppercase tracking-wide">Batches</span>
            </div>
            <p className="text-3xl font-semibold text-[var(--forest)]">{batches.length}</p>
          </div>
          <div className="bg-white border border-black/[0.06] rounded-xl p-4">
            <div className="flex items-center gap-2 mb-2">
              <FlaskConical className="w-4 h-4 text-purple-500" />
              <span className="text-xs text-[var(--clay)] uppercase tracking-wide">TC</span>
            </div>
            <p className="text-3xl font-semibold text-[var(--forest)]">{batches.filter(b => b.propagationType === 'TC').length}</p>
          </div>
          <div className="bg-white border border-black/[0.06] rounded-xl p-4">
            <div className="flex items-center gap-2 mb-2">
              <TreeDeciduous className="w-4 h-4 text-blue-500" />
              <span className="text-xs text-[var(--clay)] uppercase tracking-wide">Divisions</span>
            </div>
            <p className="text-3xl font-semibold text-[var(--forest)]">{batches.filter(b => b.propagationType === 'DIVISION' || b.propagationType === 'OFFSET').length}</p>
          </div>
          <div className="bg-white border border-black/[0.06] rounded-xl p-4">
            <div className="flex items-center gap-2 mb-2">
              <Sprout className="w-4 h-4 text-emerald-500" />
              <span className="text-xs text-[var(--clay)] uppercase tracking-wide">Individuals</span>
            </div>
            <p className="text-3xl font-semibold text-[var(--forest)]">{batches.reduce((sum, b) => sum + (b.currentCount || b.acquiredCount), 0)}</p>
          </div>
        </div>
